            ...
            <div className="flex-1 flex items-center justify-center gap-1 sm:gap-1.5">
              ...
              {viewMode !== 'reflow' && !isEpub && document?.content_type !== 'webtoon' && (
                <>
                  ...
                  <button onClick={() => setAutoCrop(!autoCrop)}
                    className={`p-1.5 rounded-lg transition-colors ${autoCrop ? 'bg-[#B2967D] text-[#1A1410]' : 'text-[#C4A882] hover:text-[#EEE4E1] hover:bg-[#2E2620]'}`}
