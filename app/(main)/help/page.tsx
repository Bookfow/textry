...
const FAQ_DATA = [
  {
    ...
    questions: [
      {
        q: 'Textry는 무엇인가요?',
        a: 'Textry는 PDF 문서를 유튜브처럼 쉽게 공유하고 소비할 수 있는 플랫폼입니다. 큐레이터는 콘텐츠를 업로드하여 수익을 얻고, 독자는 무료로 다양한 콘텐츠를 읽을 수 있습니다.'
      },
      {
      ...
      {
        q: '무료로 사용할 수 있나요?',
        a: '네! 모든 사용자가 무료로 문서를 읽을 수 있으며, 큐레이터 역시 무료로 콘텐츠를 업로드할 수 있습니다.'
      }
    ]
  },
  {
