...
const FAQ_DATA = [
  {
    ...
    questions: [
      {
        q: 'TeXTREME는 무엇인가요?',
        a: 'TeXTREME는 PDF 콘텐츠를 유튜브처럼 쉽게 공유하고 소비할 수 있는 플랫폼입니다. 큐레이터는 콘텐츠를 업로드하여 수익을 얻고, 독자는 무료로 다양한 콘텐츠를 읽을 수 있습니다.'
      },
      {
        q: '큐레이터와 독자의 차이는 무엇인가요?',
        a: '큐레이터는 콘텐츠를 업로드하고 광고 수익을 얻을 수 있으며, 독자는 콘텐츠를 읽고 좋아요, 댓글, 구독 등의 활동을 할 수 있습니다.'
      },
      {
        q: '무료로 사용할 수 있나요?',
        a: '네! 모든 사용자가 무료로 콘텐츠를 읽을 수 있으며, 큐레이터 역시 무료로 콘텐츠를 업로드할 수 있습니다.'
      }
    ]
  },
  {
    ...
    questions: [
      ...
      {
        q: '콘텐츠를 업로드하면 바로 공개되나요?',
        a: '네, 업로드 즉시 공개되며 다른 사용자들이 검색하고 읽을 수 있습니다.'
      },
      {
        q: '업로드한 콘텐츠를 삭제할 수 있나요?',
        a: '네, 대시보드에서 언제든지 삭제할 수 있습니다. 삭제된 콘텐츠는 복구할 수 없으니 신중하게 결정해주세요.'
      }
    ]
  },
  {
    ...
    questions: [
      {
        q: '수익은 어떻게 발생하나요?',
        a: '콘텐츠 조회수와 읽기 시간을 기반으로 광고 수익이 계산됩니다. 조회수당 $0.01, 읽기 시간(분)당 $0.05의 수익이 발생합니다.'
      },
      {
        q: '수익은 언제 정산되나요?',
  ...
  },
  {
    ...
    questions: [
      {
        q: '구독 기능은 어떻게 사용하나요?',
        a: '좋아하는 큐레이터의 프로필 또는 콘텐츠 페이지에서 구독 버튼을 클릭하면 됩니다. 구독한 큐레이터의 새 콘텐츠는 홈 피드와 알림에서 확인할 수 있습니다.'
      },
      {
        q: '읽기 목록은 무엇인가요?',
        a: '나중에 읽고 싶은 콘텐츠를 저장해두는 기능입니다. 콘텐츠 카드의 북마크 버튼을 클릭하면 읽기 목록에 추가됩니다.'
      },
      {
        q: '카테고리와 언어 필터는 어떻게 사용하나요?',
        a: '상단 검색바 또는 사이드바에서 원하는 카테고리와 언어를 선택하면 해당 조건에 맞는 콘텐츠만 볼 수 있습니다.'
      }
    ]
  },
  {
