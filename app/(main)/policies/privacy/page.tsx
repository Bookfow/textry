    ...
    <div className="min-h-screen bg-gray-50 dark:bg-gray-950">
      <main className="max-w-3xl mx-auto px-4 md:px-6 py-8 md:py-12">
        ...
        <div className="prose prose-sm dark:prose-invert max-w-none space-y-6">
            ...
            <div className="not-prose mt-3 overflow-x-auto">
              <table className="w-full text-sm border dark:border-gray-700">
                ...
                <tbody className="text-gray-700 dark:text-gray-300">
                  ...
                  <tr><td className="border dark:border-gray-700 px-3 py-2">Google LLC</td><td className="border dark:border-gray-700 px-3 py-2">광고 서비스(AdSense)</td></tr>
                  <tr><td className="border dark:border-gray-700 px-3 py-2">주식회사 카카오</td><td className="border dark:border-gray-700 px-3 py-2">소셜 로그인(카카오)</td></tr>
                  <tr><td className="border dark:border-gray-700 px-3 py-2">네이버 주식회사</td><td className="border dark:border-gray-700 px-3 py-2">소셜 로그인(네이버)</td></tr>
                </tbody>
              </table>
            </div>
          ...
          <section>
            <h2 className="text-xl font-bold mt-8 mb-3">12. 개인정보 보호책임자 및 사업자 정보</h2>
            ...
            <div className="not-prose mt-4 overflow-x-auto">
              <table className="w-full text-sm border dark:border-gray-700">
                <thead>
                  <tr className="bg-gray-100 dark:bg-gray-800">
                    <th className="border dark:border-gray-700 px-3 py-2 text-left text-gray-900 dark:text-white" colSpan={2}>사업자 정보</th>
                  </tr>
                </thead>
                <tbody className="text-gray-700 dark:text-gray-300">
                  <tr><td className="border dark:border-gray-700 px-3 py-2 font-medium">상호</td><td className="border dark:border-gray-700 px-3 py-2">텍스트림(TeXTREME)</td></tr>
                  <tr><td className="border dark:border-gray-700 px-3 py-2 font-medium">사업자등록번호</td><td className="border dark:border-gray-700 px-3 py-2">653-33-01529</td></tr>
                  <tr><td className="border dark:border-gray-700 px-3 py-2 font-medium">업태</td><td className="border dark:border-gray-700 px-3 py-2">정보통신업, 서비스업</td></tr>
                  <tr><td className="border dark:border-gray-700 px-3 py-2 font-medium">종목</td><td className="border dark:border-gray-700 px-3 py-2">포털 및 기타 인터넷 정보 매개 서비스업, 광고대행업</td></tr>
                </tbody>
              </table>
            </div>
          </section>
