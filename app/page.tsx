      ...
      <nav className="fixed top-0 left-0 right-0 z-50 transition-all duration-500 bg-[#FAF6F1]/90 backdrop-blur-md border-b border-[#D4C4B0]/80">
        <div className="max-w-7xl mx-auto px-6 py-4 flex items-center justify-between">
          <Link href="/" className="flex items-center gap-2">
            <h1 className="text-xl font-bold bg-gradient-to-r from-[#a67c52] via-[#f0d58c] to-[#a67c52] bg-clip-text text-transparent warm-text" style={{ WebkitTextStroke: '0.3px #daa520', paintOrder: 'stroke fill', letterSpacing: '1.5px' }}>TeXTREME</h1>
          </Link>
        ...
        <div className="relative z-10 max-w-6xl mx-auto px-6">
          <>
              <div className="text-center mb-16 md:mb-20">
                ...
                <h3 className="text-3xl md:text-5xl font-black text-[#2D2016] mb-6 animate-fadeInUp wiggle-hover" style={{ animationDelay: '0.2s' }}>
        ...
        <div className="relative z-10 max-w-6xl mx-auto px-6">
          <>
              <div className="text-center mb-16 md:mb-20">
                ...
                <h3 className="text-3xl md:text-5xl font-black text-[#2D2016] animate-fadeInUp wiggle-hover" style={{ animationDelay: '0.2s' }}>
                  읽기의 모든 순간을 디자인하다
                </h3>
              </div>
        ...
        <div className="max-w-6xl mx-auto px-6">
          <div className="flex flex-col md:flex-row items-center justify-between gap-6">
            <div className="flex items-center gap-4">
              <h2 className="text-xl font-bold bg-gradient-to-r from-[#a67c52] via-[#f0d58c] to-[#a67c52] bg-clip-text text-transparent warm-text" style={{ WebkitTextStroke: '0.3px #daa520', paintOrder: 'stroke fill', letterSpacing: '1.5px' }}>TeXTREME</h2>
