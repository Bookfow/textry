      ...
      <nav className="fixed top-0 left-0 right-0 z-50 transition-all duration-500 bg-[#FAF6F1]/90 backdrop-blur-md border-b border-[#D4C4B0]/80">
        <div className="max-w-7xl mx-auto px-6 py-4 flex items-center justify-between">
          <Link href="/" className="flex items-center gap-2">
            <h1 className="text-xl warm-text" style={{ fontFamily: "'Monoton', cursive", letterSpacing: '2px' }}>TeXTREME</h1>
          </Link>
        ...
        <div className="max-w-6xl mx-auto px-6">
          <div className="flex flex-col md:flex-row items-center justify-between gap-6">
            <div className="flex items-center gap-4">
              <h2 className="text-xl warm-text" style={{ fontFamily: "'Monoton', cursive", letterSpacing: '2px' }}>TeXTREME</h2>
