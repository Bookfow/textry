  ...
  return (
    <footer className="border-t border-[#E7D8C9] dark:border-[#3A302A] bg-[#F7F2EF] dark:bg-[#1A1410]">
      <div className="max-w-[1400px] mx-auto px-4 md:px-6 lg:px-8 py-6">
        <div className="flex flex-wrap gap-x-4 gap-y-1 text-xs text-[#9C8B7A]">
...
cd C:\Users\user\textry && git add . && git commit -m "fix: 푸터 개인정보처리방침 bold 제거" && git push
        ...
        <p className="text-[11px] text-[#C4B5A6] dark:text-[#5C4A38] mt-3">© 2026 Textry. All rights reserved.</p>
      </div>
    </footer>
  )
}
